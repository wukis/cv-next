                ...
                <div className="flex flex-col md:flex-row gap-10 items-center">
                    <div className="flex-shrink-0 max-w-[200px] lg:max-w-[220px]">
                        ...
                        <div className="mt-5 flex justify-center gap-5">
                            <SocialLink href="mailto:jonas@petrik.dev" icon={MailIcon} aria-label="Send email to Jonas Petrik" />
                            <SocialLink href="https://www.linkedin.com/in/jonas-petrik/" target="_blank" rel="noopener noreferrer" aria-label="Visit Jonas Petrik's LinkedIn profile" icon={LinkedInIcon} />
                            <SocialLink href="https://github.com/wukis" target="_blank" rel="noopener noreferrer" aria-label="Visit Jonas Petrik's GitHub profile" icon={GitHubIcon} />
                            <SocialLink href="https://gitlab.com/jonas.petrik" target="_blank" rel="noopener noreferrer" aria-label="Visit Jonas Petrik's GitLab profile" icon={GitLabIcon} />
                        </div>
                    </div>
