        ...
        <Container className="mt-16 sm:mt-24">
            ...
            <div className="mt-8 flex justify-end">
                <Link 
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-500/30 dark:bg-amber-400/30 text-amber-800 dark:text-amber-200 font-mono text-sm hover:bg-amber-500/40 dark:hover:bg-amber-400/40 transition-colors"
                >
                            ...
                            <div className="flex-shrink-0">
                                ...
                                <div className="mt-3 flex flex-row gap-1.5 justify-center">
                                    <Link 
                                        ...
                                        className="p-1.5 rounded-md bg-neutral-100 dark:bg-neutral-800 hover:bg-emerald-500/30 dark:hover:bg-emerald-400/30 hover:text-emerald-700 transition-colors"
                                        aria-label="Email"
                                    >
