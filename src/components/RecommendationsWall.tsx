...
function Recommendation({
  ...
  return (
    <article id={recommendation.slug} className="scroll-mt-20">
      <div
        className={`relative overflow-hidden rounded-sm border border-neutral-200/70 bg-white/90 backdrop-blur-xs transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-950/90 ${recommendationAccent.hoverBorder} ${
          isHighlighted
            ? `border-l-2 border-l-emerald-500 shadow-lg dark:border-l-emerald-400`
            : ''
        }`}
      >
        {/* Terminal header */}
        ...
        <div className="p-5">
          ...
          <blockquote className="relative mb-4">
            ...
            <p className="pr-2 pl-4 text-sm leading-relaxed text-neutral-700 dark:text-neutral-200">
              {recommendation.body}
            </p>
          </blockquote>
          ...
          <div className="flex items-center gap-3 border-t border-neutral-200 pt-4 dark:border-neutral-700">
            <Image
              className="h-10 w-10 shrink-0 rounded-sm object-cover ring-2 ring-white dark:ring-neutral-800"
              width={40}
              height={40}
